      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            {/* Location */}
            <div className="flex items-start text-sm text-primary-foreground/80 mb-6">
          ...
          {/* Verticals */}
          <div>
            <h3 className="font-semibold mb-4 text-sm">Verticals</h3>
          ...
          <div className="space-y-8">
            {/* Conversational AI */}
            <div>
              <h3 className="font-semibold mb-4 text-sm">Conversational AI</h3>
              <ul className="space-y-2">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li>
                  <a href="/case-studies" className="text-primary-foreground/70 hover:text-primary-foreground transition-colors text-sm">
                    Case Studies
                  </a>
                </li>
                <li>
                ...
                <li>
                  <a href="/careers" className="text-primary-foreground/70 hover:text-primary-foreground transition-colors text-sm">
                    Careers
                  </a>
                </li>
                <li>
            ...
            <div className="bg-white/5 backdrop-blur-sm rounded-lg p-4 border border-white/10">
              ...
              <button className="text-tech-accent font-semibold hover:scale-105 transition-transform duration-200 cursor-pointer text-sm">
                Let's talk.
              </button>
            </div>
          </div>
